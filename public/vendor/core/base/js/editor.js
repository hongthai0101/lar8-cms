...
/***/ "./packages/core/base/resources/assets/js/forms/ckeditor-upload-adapter.js":
/*!*********************************************************************************!*\
  !*** ./packages/core/base/resources/assets/js/forms/ckeditor-upload-adapter.js ***!
  \*********************************************************************************/
...
(() => {
/*!**********************************************************!*\
  !*** ./packages/core/base/resources/assets/js/editor.js ***!
  \**********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _forms_ckeditor_upload_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./forms/ckeditor-upload-adapter */ "./packages/core/base/resources/assets/js/forms/ckeditor-upload-adapter.js");
    ...
    value: function initCkEditor(element, extraConfig) {
      ...
      ClassicEditor.create(document.querySelector('#' + element), _objectSpread({
        ...
        editor.plugins.get('FileRepository').createUploadAdapter = function (loader) {
          return new _forms_ckeditor_upload_adapter__WEBPACK_IMPORTED_MODULE_0__.default(loader, RV_MEDIA_URL.media_upload_from_editor, editor.t);
