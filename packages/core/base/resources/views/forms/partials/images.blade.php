<div class="gallery-images-wrapper list-images">
    ...
    <div class="images-wrapper">
        <div data-name="{{ $name }}"
            ...
            <img src="{{ Media::getDefaultImage(false) }}" alt="{{ trans('core/base::base.image') }}" width="120">
            <br>
                        ...
                        <li class="gallery-image-item-handler">
                            ...
                            <div class="custom-image-box image-box">
                                <input type="hidden" name="{{ $name }}" value="{{ $image }}" class="image-data">
                                    ...
                                    <img src="{{ Media::getImageUrl($image, Arr::get($attributes, 'allow_thumb', true) == true ? 'thumb' : null) }}" alt="{{ trans('core/base::base.preview_image') }}"
                                         class="preview_image">
                                </div>
                            </div>
                        </li>
    ...
    @push('footer')
        <script id="gallery_select_image_template" type="text/x-custom-template">
            ...
            <div class="custom-image-box image-box">
                ...
                <img src="{{ Media::getDefaultImage(false) }}" alt="{{ trans('core/base::base.preview_image') }}" class="preview_image">
