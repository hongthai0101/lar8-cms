                        ...
                        @if (array_key_exists('image', config('core.media.media.mime_types', [])))
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="image">
                                    <i class="fa fa-file-picture-o"></i> {{ trans('core/media::media.image') }}
                                </a>
                            </li>
                        @endif
                        @if (array_key_exists('video', config('core.media.media.mime_types', [])))
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="video">
                                    <i class="fa fa-file-movie-o"></i> {{ trans('core/media::media.video') }}
                                </a>
                            </li>
                        @endif
                        <li>
            ...
            <div class="rv-media-block rv-media-view-in">
                ...
                <div class="rv-media-block-content">
                    <ul class="rv-media-aside-list">
                        ...
                        @if (Media::hasAnyPermission(['folders.destroy', 'files.destroy']))
                            <li>
            ...
            <header class="rv-media-header">
                <div class="rv-media-top-header">
                    <div class="rv-media-actions">
                        ...
                        @if (Media::hasPermission('files.create'))
                        ...
                        <div class="btn-group" role="group">
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle"
                                    ...
                                    {{ trans('core/media::media.sort') }} <i class="fa fa-sort-alpha-asc"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right" style="min-width: 200px; font-size: 12px !important;">
                                    <li>
                                        <a href="#"
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="created_at-asc">
                                            <i class="fa fa-sort-alpha-asc"></i> {{ trans('core/media::media.uploaded_date_asc') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="created_at-desc">
                                            <i class="fa fa-sort-alpha-desc"></i> {{ trans('core/media::media.uploaded_date_desc') }}
                                        </a>
                                    </li>
                                    <li role="separator" class="divider"></li>
                                </ul>
                            ...
                            <div class="dropdown rv-dropdown-actions disabled">
                                ...
                                <ul class="dropdown-menu" style="min-width: 180px; font-size: 12px"></ul>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <i class="fa fa-th-large"></i> {{ trans('core/media::media.coming_soon') }}
                        </h4>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="rv-form form-rename">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fa fa-th-large"></i> {{ trans('core/media::media.rename') }}
                            </h4>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fa fa-th-large"></i> {{ trans('core/media::media.move_to_trash') }}
                            </h4>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fa fa-th-large"></i> {{ trans('core/media::media.confirm_delete') }}
                            </h4>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-empty-trash">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fa fa-th-large"></i> {{ trans('core/media::media.empty_trash_title') }}
                            </h4>
